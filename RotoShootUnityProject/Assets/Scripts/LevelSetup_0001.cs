...
public class LevelSetup_0001 : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    {
      new EnemySpawnPoint(LevelEnemyPrefabs[0], new Vector2 (7.5f,-14), 1f, 1),
      new EnemySpawnPoint(LevelEnemyPrefabs[0], new Vector2 (-7.5f,-14), 1.5f, 1),
      new EnemySpawnPoint(LevelEnemyPrefabs[0], new Vector2 (8,2), 1f, 1),
      new EnemySpawnPoint(LevelEnemyPrefabs[0], new Vector2 (-8,2), 1.5f, 1),
      new EnemySpawnPoint(LevelEnemyPrefabs[0], new Vector2 (-10,-6), 1.25f, 1),
      new EnemySpawnPoint(LevelEnemyPrefabs[0], new Vector2 (12,-6), 1.25f, 1),
      new EnemySpawnPoint(LevelEnemyPrefabs[0], new Vector2 (0,25), 5f, 1)
    };    
  }
