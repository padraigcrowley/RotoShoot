...
public class GameplayManager : Singleton<GameplayManager>, IPowerUpEvents
{
  ...
  [HideInInspector] public enum GameState {
    WAITING_FOR_LEVELCOMPLETE_BUTTONS, WAITING_FOR_PLAYERDIED_BUTTONS, WAITING_FOR_START_BUTTON, LEVEL_INTRO_IN_PROGRESS, LEVEL_IN_PROGRESS, LEVEL_FAILED, LEVEL_OUTRO_IN_PROGRESS, LEVEL_COMPLETE, GAME_OVER_SCREEN, PLAYER_DYING, PLAYER_DIED, EXITING_LEVEL }
